...
function initContactForm() {
    ...
    // Found in your code: "sm08AnEPv9i2Vfjzu"
    emailjs.init("x4y1NBT4WVWV-MYYB"); 
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            // 2. Send the form using Service ID and Template ID
            // Found in your code: Service="service_jtnlzjh", Template="template_1g0ebr8"
            emailjs.sendForm('service_28dkqcc', 'template_iwxj1ad', this)
                .then(() => {
...
// --- REST OF YOUR UI FUNCTIONS (Keep these as they were) ---
...
function initTypingEffect() {
    // Make sure the element ID 'typing-text' exists in your HTML
